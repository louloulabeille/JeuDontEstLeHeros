...
namespace JeuDontEstLeHeros.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private HerosIdentityUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<HerosIdentityUser>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(HerosIdentityUser)}'. " +
                    $"Ensure that '{nameof(HerosIdentityUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
                    $"override the register page in /Areas/Identity/Pages/Account/Register.cshtml");
            }
        }

        private IUserEmailStore<HerosIdentityUser> GetEmailStore()
        {
